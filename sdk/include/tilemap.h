 ...
 * 5. ngres.py generates NGTilemapAsset
 *
 ...
 *  @brief Generated by ngres from Tiled TMX files.
 *  @{
 */

/**
 * Tilemap asset definition.
 * Generated by ngres from TMX files in assets.yaml.
 */
typedef struct {
 ...
 * @param asset Tilemap asset (generated by ngres)
