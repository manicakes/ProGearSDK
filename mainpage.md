...
```c
#include <progear.h>         // All ProGear + HAL headers
...
Include `<progear.h>` for all modules (includes HAL automatically).
...
- [ProGear README](progear/README.md) - Game engine details
