...
/**
 * @defgroup ui UI System
 * @ingroup sdk
 * @brief Sprite-based menus and dialogs with spring animations.
 * @{
 */
...
/**
 * NGMenuCreateDefault() - Create menu with SDK default assets.
 * This convenience wrapper is generated by progear_assets.py in progear_assets.h
 * when SDK assets are included. See that header for the implementation.
 */
/** @} */
...
/**
 * NGMenuSetDefaultSounds() - Set SDK default menu sounds.
 * This convenience wrapper is generated by progear_assets.py in progear_assets.h
 * when SDK assets are included. See that header for the implementation.
 */
/** @} */
